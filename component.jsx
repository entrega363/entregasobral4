            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-gray-900">
                      {pedidos.filter(p => p.status === 'aguardando_entregador').length}
                    </div>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-gray-900">
                      {pedidos.filter(p => p.entregadorId === entregadorLogado.id && p.status === 'entrega').length}
                    </div>
              ...
              <div className="bg-white shadow rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-gray-900">
                      {pedidos.filter(p => p.entregadorId === entregadorLogado.id && p.status === 'entregue').length}
                    </div>
            ...
            <div className="bg-white shadow rounded-lg p-6 mb-6">
              ...
              <div className="space-y-4">
                {(() => {
                  ...
                  return pedidosDisponiveis.map(pedido => (
                    <div key={pedido.id} className="border border-gray-200 rounded-lg p-4">
                      ...
                      {/* Empresas envolvidas */}
                      <div className="mb-4">
                        <h4 className="font-medium text-gray-900 mb-2">🏢 Empresas:</h4>
                        <div className="space-y-1">
                          {pedido.empresas.map((empresa, index) => (
                            <div key={index} className="text-sm text-gray-600">
                              • {empresa.empresaNome} - R$ {empresa.subtotal.toFixed(2)}
                            </div>
                          ))}
                        </div>
                      </div>
