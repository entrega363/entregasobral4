...
Endere\xE7o: ${pedido.endereco}, ${pedido.bairro}`);
  ...
  if (entregadorLogado) {
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50" }, /* @__PURE__ */ React.createElement("header", { className: "bg-white shadow-sm border-b sticky top-0 z-50" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center h-16" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-bold text-green-600" }, "\u{1F3CD}\uFE0F ", entregadorLogado.nome), /* @__PURE__ */ React.createElement("span", { className: "ml-4 text-sm text-gray-600" }, "Painel do Entregador")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center space-x-4" }, /* @__PURE__ */ React.createElement(
      ...
      "Sair"
    ))))), /* @__PURE__ */ React.createElement("main", { className: "max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" }, /* @__PURE__ */ React.createElement("div", { className: "px-4 py-6 sm:px-0" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white shadow rounded-lg p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl mr-4" }, "\u{1F4E6}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-gray-900" }, pedidos.filter((p) => p.status === "aguardando_entregador").length), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Pedidos Dispon\xEDveis")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white shadow rounded-lg p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl mr-4" }, "\u{1F69A}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-gray-900" }, pedidos.filter((p) => p.entregadorId === entregadorLogado.id && p.status === "entrega").length), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Em Entrega")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white shadow rounded-lg p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-3xl mr-4" }, "\u2705"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-bold text-gray-900" }, pedidos.filter((p) => p.entregadorId === entregadorLogado.id && p.status === "entregue").length), /* @__PURE__ */ React.createElement("div", { className: "text-sm text-gray-600" }, "Entregues"))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white shadow rounded-lg p-6 mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-6" }, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-bold text-gray-900" }, "\u{1F4E6} Pedidos Dispon\xEDveis"), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          const savedPedidos = localStorage.getItem("pedidos_sobral");
      ...
      if (pedidosDisponiveis.length === 0) {
        return /* @__PURE__ */ React.createElement("div", { className: "text-center py-8" }, /* @__PURE__ */ React.createElement("div", { className: "text-4xl mb-4" }, "\u{1F4E6}"), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-medium text-gray-900 mb-2" }, "Nenhum pedido dispon\xEDvel"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600" }, "Aguarde novos pedidos ficarem prontos para entrega."));
      }
      return pedidosDisponiveis.map((pedido) => /* @__PURE__ */ React.createElement("div", { key: pedido.id, className: "border border-gray-200 rounded-lg p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start mb-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-semibold text-gray-900" }, "Pedido #", pedido.id.slice(-6)), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Disponibilizado em: ", pedido.disponibilizadoEm), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-700 mt-1" }, /* @__PURE__ */ React.createElement("strong", null, "Cliente:"), " ", pedido.consumidorNome), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-700" }, /* @__PURE__ */ React.createElement("strong", null, "Telefone:"), " ", pedido.telefone)), /* @__PURE__ */ React.createElement("div", { className: "text-right" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-bold text-green-600" }, "R$ ", pedido.total.toFixed(2)), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-gray-500" }, pedido.items.length, " item(s)"))), /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 rounded-lg p-3 mb-4" }, /* @__PURE__ */ React.createElement("h4", { className: "font-medium text-gray-900 mb-1" }, "\u{1F4CD} Endere\xE7o de Entrega:"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-700" }, pedido.endereco, ", ", pedido.bairro)), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h4", { className: "font-medium text-gray-900 mb-2" }, "\u{1F3E2} Empresas:"), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, pedido.empresas.map((empresa, index) => /* @__PURE__ */ React.createElement("div", { key: index, className: "text-sm text-gray-600" }, "\u2022 ", empresa.empresaNome, " - R$ ", empresa.subtotal.toFixed(2))))), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => {
...
Valor: R$ ${pedido.total.toFixed(2)}`)) {
              ...
              setPedidos(pedidosAtualizados);
              localStorage.setItem("pedidos_sobral", JSON.stringify(pedidosAtualizados));
              alert("\u2705 Entrega aceita! Boa sorte!");
            }
          },
